...
**English** · [繁體中文](.github/README.zh-Hant.md) · [简体中文](.github/README.zh-Hans.md) · [日本語](.github/README.ja.md)
...
Claude Code can use the same skill sources from `.claude/skills/` or through the bundled plugin. Full setup and troubleshooting lives in [INSTALL.md](INSTALL.md).
...
See [docs/sources.md](docs/sources.md) and [docs/protocol-spec.md](docs/protocol-spec.md) for the Nordic official references and documented PPK2 behavior used by the project.
...
See [ROADMAP.md](ROADMAP.md) for versioned exit criteria and the hardware compatibility matrix.

## Documentation

| Document | Covers |
|---|---|
| [INSTALL.md](INSTALL.md) | Python, USB permissions, Claude Code, Codex, CI, and troubleshooting |
| [ROADMAP.md](ROADMAP.md) | Milestones, support levels, and release exit criteria |
...
| [docs/logic-port.md](docs/logic-port.md) | D0-D7 wiring, Logic VCC, levels, and usable bandwidth |
| [docs/decoders.md](docs/decoders.md) | UART/SPI contracts, confidence, gaps, and physical limits |
| [docs/triggers.md](docs/triggers.md) | Trigger types and pre/post-trigger capture windows |
| [docs/energy-analysis.md](docs/energy-analysis.md) | Charge, energy, peak-current, and latency definitions |
| [docs/agent-interface.md](docs/agent-interface.md) | JSON, tools, state-changing operations, and context budgets |
| [docs/sources.md](docs/sources.md) | Nordic official documentation and repository references |
| [SECURITY.md](SECURITY.md) | Hardware, USB, file, and untrusted-input security model |
...
Released under the [MIT License](LICENSE). It covers the original material in this repository only — PPK2 hardware, Nordic firmware, Nordic documentation, and trademarks remain with their owners.
